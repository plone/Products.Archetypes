...
class BaseUnit(File):
        ...
        if data:
            ...
            if portal_encoding != encoding:
                try:
                    ...
                    # FIXME: Encolpe Degoute 2006-09-27
                    # Wrong encoding here, I suppose that _data was well encoded
                    pass
            return _data
    ...
    def getRaw(self, encoding=None, instance=None):
        ...
        try:
            ...
            # FIXME: Encolpe Degoute 2006-09-27
            # The last fallback was wrong, I suppose that UTF-8 is a good value
